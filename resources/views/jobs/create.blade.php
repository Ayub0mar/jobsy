...
<head>
    ...
    <title>Create a Job - Jobsy</title>
        ...
        <div class="card p-4 mt-4">
            ...
            <form action="{{ route('jobs.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="requirements" name="requirements" class="form-control" rows="5">{{ old('requirements') }}</textarea>
